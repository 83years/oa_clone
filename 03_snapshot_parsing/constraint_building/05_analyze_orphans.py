...
class OrphanAnalyzer:
    ...
    def analyze_all_orphans(self):
        ...
        # Authorship table (CRITICAL - no institution_id here!)
        ...
        self.log("\nAnalyzing AUTHORSHIP_INSTITUTIONS table...")
        total_orphans += self.find_orphans('authorship_institutions', 'author_id', 'authors', 'author_id', 'author')
        total_orphans += self.find_orphans('authorship_institutions', 'work_id', 'works', 'work_id', 'work')
        total_orphans += self.find_orphans('authorship_institutions', 'institution_id', 'institutions', 'institution_id', 'institution')
