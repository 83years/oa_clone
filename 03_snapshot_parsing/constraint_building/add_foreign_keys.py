...
class ForeignKeyBuilder:
    ...
    def add_all_foreign_keys(self):
        """Add all foreign key constraints"""
        self.log("\n" + "="*70)
        self.log("ADDING FOREIGN KEY CONSTRAINTS (NOT VALID)")
        self.log("="*70 + "\n")

        # Authorship table (CRITICAL)
        self.log("PHASE 1: Authorship Table Foreign Keys")
        self.add_foreign_key('authorship', 'work_id', 'works', 'work_id')
        self.add_foreign_key('authorship', 'author_id', 'authors', 'author_id')
        self.add_foreign_key('authorship', 'institution_id', 'institutions', 'institution_id')

        # Work relationship tables
        self.log("\nPHASE 2: Work Relationship Foreign Keys")
        ...
        self.log("\nPHASE 3: Citation and Reference Foreign Keys")
        ...
        self.log("\nPHASE 4: Author Relationship Foreign Keys")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Add Foreign Keys to Database')
    ...
    try:
        success = builder.add_all_foreign_keys()
